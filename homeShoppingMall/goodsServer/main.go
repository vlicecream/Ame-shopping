...
import (
	...
	"homeShoppingMall/goodsServer/consulRegister"
	"homeShoppingMall/goodsServer/dao/mysql"
	"homeShoppingMall/goodsServer/dao/redis"
	"homeShoppingMall/goodsServer/handler"
	"homeShoppingMall/goodsServer/logger"
	"homeShoppingMall/goodsServer/proto"
	"homeShoppingMall/goodsServer/settings"
	"homeShoppingMall/goodsServer/utils"
	"net"
	"os"
	"os/signal"
	"syscall"
...
func main() {
	...
	//	zap.L().Error("Main es.Init failed")
	//}
	// 小插曲 初始化动态端口
	...
	proto.RegisterGoodsServerServer(server, &handler.GoodsServerServer{})
