...
type AppConfig struct {
	...
	RocketMQ        *RocketMQ        `mapstructure:"rocketmq" json:"rocketmq"`
	SnowflakeConfig *SnowflakeConfig `mapstructure:"snowflake" json:"snowflake"`
	GoodsClient     *GoodsClient     `mapstructure:"goods" json:"goods"`
	InventoryClient *InventoryClient `mapstructure:"inventory" json:"inventory"`
...
type MysqlConfig struct {
	...
	SetMaxOpenConns int    `mapstructure:"setMaxOpenConns" json:"setMaxOpenConns"`
	SetMaxIdleConns int    `mapstructure:"setMaxIdleConns" json:"setMaxIdleConns"`
}
